...
impl ServerTerminal {
    ...
    // vte 0.15 may skip following bytes when completing a split character using lookahead.
    // Finish a pending character separately, then preserve the normal bulk parsing path.
