...
fn measure_alternating_width_and_history_row_reuse() -> Outcome {
    ...
    println!(
        "ROW-REUSE-TIMES {{\"frames_per_run\":4000,\"warmups\":1,\"reused_us\":{reused_us:?},\"rebuilt_us\":{rebuilt_us:?},\"reused_extractions_after_warmup\":0,\"retained_rows\":{},\"retained_bytes\":{},\"forced_extractions\":{}}}",
        reused.entries.len(),
        reused.bytes,
        rebuilt.extractions
    );
