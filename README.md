...
[`fux-fuzz`](fux-fuzz/README.md) is an unpublished, opt-in black-box harness for replayable startup, resize and shutdown scenarios. It runs separately from the normal tests and CI; its documentation records the currently reproducible startup-configuration finding.
